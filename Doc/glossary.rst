...
.. glossary::
   ...
   awaitable
      An object that can be used in :keyword:`await` expression.  Can be
   ...
   coroutine
      Coroutines can suspend their execution in :keyword:`await` expressions,
      and :keyword:`async for` and :keyword:`async with` statements. See also
      :pep:`492`.
