...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='WITH_CLEANUP_EXIT', opcode=81, arg=None, argval=None, argrepr='', offset=211, starts_line=None, is_jump_target=True),
  Instruction(opname='WITH_CLEANUP_FINAL', opcode=82, arg=None, argval=None, argrepr='', offset=212, starts_line=None, is_jump_target=False),
